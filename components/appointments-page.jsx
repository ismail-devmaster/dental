        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex space-x-4">
              ...
              <a href="#" className="bg-blue-500 text-white px-3 py-2 rounded-md text-sm font-medium">Appointments</a>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Tabs defaultValue="book-new" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8 bg-blue-100 dark:bg-gray-700 rounded-lg p-1">
            <TabsTrigger value="book-new" className="data-[state=active]:bg-white data-[state=active]:text-blue-600 dark:data-[state=active]:bg-gray-600 dark:data-[state=active]:text-white">Book New</TabsTrigger>
            <TabsTrigger value="upcoming" className="data-[state=active]:bg-white data-[state=active]:text-blue-600 dark:data-[state=active]:bg-gray-600 dark:data-[state=active]:text-white">Upcoming</TabsTrigger>
            <TabsTrigger value="history" className="data-[state=active]:bg-white data-[state=active]:text-blue-600 dark:data-[state=active]:bg-gray-600 dark:data-[state=active]:text-white">History</TabsTrigger>
            <TabsTrigger value="reminders" className="data-[state=active]:bg-white data-[state=active]:text-blue-600 dark:data-[state=active]:bg-gray-600 dark:data-[state=active]:text-white">Reminders</TabsTrigger>
          </TabsList>
                  ...
                  <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-2">
                      {Array.from({ length: 8 }, (_, i) => (
                        <Button key={i} variant="outline" className="h-12 hover:bg-blue-50 dark:hover:bg-gray-700">
                          {`${9 + i}:00 ${i < 3 ? 'AM' : 'PM'}`}
                        </Button>
                      ))}
                    </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-gray-500">Maximum 250 characters</p>
                  </div>
                </CardContent>
              ...
              {Array.from({ length: 3 }, (_, i) => (
                <Card key={i} className="hover:shadow-lg transition-shadow duration-300">
                  ...
                  <CardContent className="pt-4">
                    ...
                    <p className="text-sm text-gray-500">Cardiology Checkup</p>
                  </CardContent>
                  <CardFooter className="flex justify-between">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="email-reminder" className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="sms-reminder" className="flex items-center space-x-2">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <div className="flex  items-center justify-between">
                    <Label htmlFor="push-reminder" className="flex items-center space-x-2">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="apply-all">Apply to all future appointments</Label>
                </div>
